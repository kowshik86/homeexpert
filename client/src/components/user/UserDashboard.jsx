...
const UserDashboard = () => {
  ...
  const handleOpenOrderDetails = (orderId) => {
    navigate(`/account/order/${orderId}?scope=${urlOrderScope}`);
  };
                    ...
                    {filteredGroceryOrders.map((order) => {
                      ...
                      return (
                        <article
                          ...
                          className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden cursor-pointer transition hover:shadow-md"
                        >
